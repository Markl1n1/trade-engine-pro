...
-- Force schema cache refresh by touching strategy_backtest_results
COMMENT ON TABLE strategy_backtest_results IS 'Stores backtest results with comprehensive metrics including profit_factor, avg_win, avg_loss, trades array, and advanced performance indicators';