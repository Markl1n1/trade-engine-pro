...
-- Schedule the refresh-market-data function to run every 15 minutes
-- This will fetch only missing data for symbols/timeframes used by active strategies
...
-- Add comment
COMMENT ON TABLE market_data IS 'Market data table with smart refresh every 15 minutes - only fetches data for active strategies and missing periods';
