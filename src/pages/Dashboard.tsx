...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <h3 className="text-lg font-bold mb-4">Recent Market Data</h3>
        <div className="text-sm text-muted-foreground">
          <p>Market data streams will be displayed here once connected to Binance.</p>
          <p className="mt-2">Expected data: BTCUSDT, ETHUSDT live prices and volume.</p>
        </div>
      </Card>
    </div>
  );
